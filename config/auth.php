...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If true, a redirect will be done on a successful registration, else
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If true, a redirect will be done on a successful login, else you'll get
    | a json response.
    |
    */
